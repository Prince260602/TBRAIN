...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = env('SECRET_KEY', default='django-insecure-=+tficroe&rwn()9*^)tg5dhs!(+s1(jto7c@e9@*59(skh097')
...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='princetarachand26@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='kdkp fwnb ysyq drgn')
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
...
DATABASES = {
    'default': dj_database_url.config(
        default=env('DATABASE_URL', default='postgres://USER:PASSWORD@localhost:5432/DBNAME'),
        conn_max_age=600
    )
}
